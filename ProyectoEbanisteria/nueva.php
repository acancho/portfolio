...
<body>
    ...
    <div class="container">
        <div class="row">
        <form method="POST" action="nueva2.php" enctype="multipart/form-data">
    <div class="mb-3">
    ...
    <div class="mb-3">
        ...
        <input type="text" class="form-control" id="localizacion" name="localizacion" value="" required>
    </div>
    <div class="mb-3">
    ...
    <div class="d-grid gap-2">
        <button type="submit" class="btn btn-outline-info">Añadir Trabajo</button>
    </div>
</form>
<a class='btn btn-outline-info mt-3' href='crud.php'>Volver</a>
