...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($_FILES['imagen']['name'] != "") {
        ...
        // Si no se ha cargado una nueva imagen, asignar un valor por defecto
        $imagen = "default.jpg"; // Por ejemplo, un archivo de imagen predeterminado
    }

    // Insertar los datos en la base de datos
    $sql = "INSERT INTO trabajos (nombre, material, tipo, localizacion, descripcion, imagen) VALUES ('$nombre', '$material', '$tipo', '$localizacion', '$descripcion', '$imagen')";

    if (mysqli_query($mysqli, $sql)) {
        echo "<div class='col-12'>
        <h2>Registro insertado correctamente</h2><a class='btn btn-outline-info' href='crud.php'>Volver</a></div>
</div>";
    } else {
        echo "Error al insertar el registro: " . mysqli_error($mysqli);
    }
}
?>
        </div>
