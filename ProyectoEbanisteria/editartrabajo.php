...
// Consulta para obtener los datos del trabajo de la base de datos
...
?>
    ...
    <form method="POST" action="editar2.php" enctype="multipart/form-data">
      ...
      <div class="mb-3">
        ...
        <input type="text" class="form-control" id="material" name="material" value="<?php echo $row['material']; ?>">
      </div>
      <div class="mb-3">
      ...
      <div class="mb-3">
        <label for="localizacion" class="form-label"><strong>Localización:</strong></label>
        <input type="text" class="form-control" id="localizacion" name="localizacion" value="<?php echo $row['localizacion']; ?>">
      </div>
      <div class="mb-3">
      ...
      <div class="d-grid gap-2">
        <button type="submit" class="btn btn-outline-info">Actualizar Trabajo</button>
      </div><br><br><a class='btn btn-outline-info' href='crud.php'>Volver</a>
    </form>
