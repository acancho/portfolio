...
<div class="container">
    ...
    // Preparar la consulta SQL para insertar la reseña en la base de datos
    $sql = "INSERT INTO resenas (nombre, descripcion, puntuacion) VALUES ('$nombre', '$descripcion', '$puntuacion')";

    // Ejecutar la consulta
    if (mysqli_query($mysqli, $sql)) {
        // Mostrar mensaje de éxito
        echo "<div class='alert alert-success text-center' role='alert'>La reseña se ha enviado correctamente.</div>";
    } else {
