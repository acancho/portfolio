...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($_FILES['imagen']['name'] != "") {
        ...
        // Si no se ha cargado una nueva imagen, mantener la imagen actual en la base de datos
        $imagen = $_POST['imagen_actual'];
    }

    // Actualizar los datos en la base de datos
    $sql = "UPDATE trabajos SET nombre='$nombre', material='$material', tipo='$tipo', localizacion='$localizacion', descripcion='$descripcion', imagen='$imagen' WHERE id='$id'";

    if (mysqli_query($mysqli, $sql)) {
        echo "<div class='col-12'>
        <h2>Registro actualizado correctamente</h2><a class='btn btn-outline-info' href='crud.php'>Volver</a></div>
</div>";
    } else {
