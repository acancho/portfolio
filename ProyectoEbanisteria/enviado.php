...
// Datos del servidor SMTP y cuenta de correo electrónico
...
try {
    ...
    $mail->setFrom($emailUsuario, $nombre);
	$mail->addAddress('adriancanch11@gmail.com');
    $mail->isHTML(true);
    $mail->Subject = "Mensaje de contacto desde la web";
    $mail->Body    = "<h3>Nombre: $nombre</h3><h3>Email: $emailUsuario</h3><p>Mensaje: $mensajeUsuario</p>";
