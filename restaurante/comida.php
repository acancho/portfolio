...
<body>
  ...
  <script>
    document.getElementById('color_mode').addEventListener('change', function() {
      if (this.checked) {
        window.location.href = 'ingles/comida.php';
      }
    });
  </script>
  ...
  <div class="container">
    ...
    <div class="container">
      ...
      <a href="comida.php" class="btn btn-lg m-3 active" role="button">Comida</a>
    ...
    $sql = "SELECT * FROM carta WHERE tipo LIKE 'comida' LIMIT " . $inicio . "," . $tamanio_pagina;
    ...
    if (mysqli_num_rows($resultado)) {
      ...
      // Paginación
      $sql_total = "SELECT COUNT(*) as total FROM carta WHERE tipo LIKE 'comida'";
      ...
      for ($i = 1; $i <= $total_paginas; $i++) {
        if ($i == $pagina) {
          ...
          echo "    <li class='page-item'><a class='page-link' href='comida.php?pagina=$i'>$i</a></li>";
        }
      }
