...
<body>
  ...
  <script>
    document.getElementById('color_mode').addEventListener('change', function() {
      if (this.checked) {
        window.location.href = 'ingles/bebida.php';
      }
    });
  </script>
  ...
  <div class="container">
    <h1>Bebida</h1>
    <div class="container">
      <a href="carta.php" class="btn btn-lg m-3" role="button">Completa</a>
      <a href="comida.php" class="btn btn-lg m-3" role="button">Comida</a>
      <a href="bebida.php" class="btn btn-lg m-3 active" role="button">Bebida</a>
    </div>
    <style>
      .btn.active {
    ...
    if (mysqli_num_rows($resultado)) {
      ...
      // Paginación
      $sql_total = "SELECT COUNT(*) as total FROM carta WHERE tipo LIKE 'bebida'";
      ...
      for ($i = 1; $i <= $total_paginas; $i++) {
        if ($i == $pagina) {
          ...
          echo "    <li class='page-item'><a class='page-link' href='bebida.php?pagina=$i'>$i</a></li>";
        }
      }
    ...
    <style>
      ...
      .card {
        ...
        transition: 0.3s;
        border-radius: 5px;
        overflow: hidden; /* Añadido para asegurar que las esquinas redondeadas se apliquen correctamente */
      }
