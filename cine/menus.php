...
<?php
  ...
  <div class="container fondonegro contenido">
    <div class="row">
      ...
      $total_resultados = mysqli_num_rows(mysqli_query($mysqli, "SELECT * FROM menus"));
      ...
      $sql = "SELECT * FROM menus LIMIT $inicio, $resultados_por_pagina";
