                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                  <ul class="navbar-nav mx-auto">                    
                    <li class="nav-item dropdown ms-5 me-5">
                      <a class="nav-link dropdown-toggle text-light fs-5" role="button" data-bs-toggle="dropdown" aria-expanded="false">CINES</a>
                    ...
                    <li class="nav-item ms-5 me-5">
                      <a class="nav-link text-light fs-5" href="registro.php">LOGIN</a>
                    </li>
                  </ul>
                </div>
              </div>
