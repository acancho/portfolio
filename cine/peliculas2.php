...
if (curl_errno($peticion)) {
    ...
    if (!isset($respuesta_decodificada['results'])) {
        echo '¡No tenemos mas peliculas que mostrar!.';
    }
}
...
.movie {
  position: relative;
  overflow: hidden;
  border: 2px solid #dc3545; /* Ajusta el color del borde según tu preferencia */
  width: 18%; /* Ajusta el ancho de cada película según tu preferencia */
  margin-bottom: 20px; /* Ajusta la separación entre películas según tu preferencia */
}
...
.movie h3 {
  margin: 0;
  max-width: calc(100% - 2rem); /* Ajusta el ancho máximo del h3 para que quepa en el contenedor */
  overflow: hidden;
  white-space: nowrap;
...
@media (max-width: 1200px) {
  .movie {
    width: 23%; /* Ajusta el ancho de cada película para dispositivos más pequeños */
  }
}

@media (max-width: 991px) {
  .movie {
    width: 30%; /* Ajusta el ancho de cada película para dispositivos aún más pequeños */
  }
}

@media (max-width: 767px) {
  .movie {
    width: 48%; /* Ajusta el ancho de cada película para dispositivos pequeños */
  }
}
.movie:hover .movie-info {
  backdrop-filter: blur(10px);
