...
<body>
  ...
  <div class="container fondonegro contenido">
    <div class="row">
      ...
      $resultados_por_pagina = 9; // Define cuántos resultados mostrar por página
      $total_resultados = mysqli_num_rows(mysqli_query($mysqli, "SELECT * FROM cines"));
      ...
      $sql = "SELECT * FROM cines LIMIT $inicio, $resultados_por_pagina";
